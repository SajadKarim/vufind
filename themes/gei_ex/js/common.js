...
function bulkFormHandler(event, data) {
  ...
  || $('.checkbox-select-item:checked,checkbox-select-allpages:checked').length === 0) {
...
$(document).ready(function commonDocReady() {
  ...
  $('.checkbox-select-all').change(function selectAllCheckboxes() {
    ...
    $form.find('.checkbox-select-allpages').prop('checked', false);

    $form.find('#ribbon-export').val('1');
  });
  $('.checkbox-select-allpages').change(function selectAllCheckboxes() {
    var $form = this.form ? $(this.form) : $(this).closest('form');
    $form.find('.checkbox-select-item').prop('checked', this.checked);
    $('[form="' + $form.attr('id') + '"]').prop('checked', this.checked);
    $form.find('.checkbox-select-allpages').prop('checked', this.checked);
    $('.checkbox-select-pages[form="' + $form.attr('id') + '"]').prop('checked', this.checked);
    $form.find('.checkbox-select-all').prop('checked', false);

    if (this.checked) {
    	$form.find('#ribbon-export').val('2');
    } else {
        $form.find('#ribbon-export').val('1');
    }
  });
